          ...
          <div key={index}>
            ...
            <article className="Post" >
              ...
              <div className="Post-caption">
                ...
                {userCurrent && <div>{userCurrent.user_name} {!findIsExisteInSupperAdmin(grs.super_admin, userCurrent) ? "is  admin" : "is not admin"} </div>}
              </div>
              {(findIsExisteInMembers(grs.members, userCurrent)) && <button onClick={() => rejoindreGroup(grs)}>Rejoinder</button>}
